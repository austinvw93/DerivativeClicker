...
function calcMult(mult){
	var index = mult - 1;
	calcMult.factors = [0.0005*player.infiniCurr, 0.002*player.infiniCurr, 0.005*player.infiniCurr, 0.01*player.infiniCurr, 0.02*player.infiniCurr, 0.04*player.infiniCurr, 0.06*player.infiniCurr];
